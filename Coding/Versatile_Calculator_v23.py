...
GEOMETERY_FORMULAS = [
    ...
    "Triangle/Pyramid: Perimeter, Area, Volume, Surface Area",
        ...
        # ==========================================
            ...
            if geometry_selection == 2:
                ...
                #-------------------------------- 
                    ...
                    # Volume
                        ...
                        while True:
                            try:
                                width = float(input("Enter the width of the object: "))
                                height_of_triangle = float(input("Enter the height of the base of the object: "))
                                height = float(input("Enter the height of the pryamid: "))
                                if(width < 0 or height < 0 or height_of_triangle < 0):
                                    print("Error: A side can not be less than 0")
                                    continue
                                break
                            except:
                        ...
                        area = (width * height_of_triangle) * 0.5
                ...
                #----------------------------------------------------------------
                    ...
                    while True:
                        try:
                            p = int(input("Enter the perimeter of your triangle: "))
                            if(p < 0):
                                print("Error: Perimeter cant be less than 0")
                                continue
                            break
                        except:
                            print("Error: Enter a number")
