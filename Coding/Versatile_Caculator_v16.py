    ...
    while True:
                ...
                while True:
                    ...
                    if(angle_or_side == 1 ):
                        ...
                        while True:
                            ...
                            angle_deg = math.degrees(angle_rad)
                            result = angle_deg
                            print(f"Your answer is(in degrees): {result:.5f}")
                            result = angle_rad
                            print(f"Your answer is(in radians): {result:.5f}")
                            break
                    elif(angle_or_side == 3):
                        while True:
                            try:
        ...
        if(geometry_selection == 1 and calc_selection_3 == 4):
            ...
            while True:
                ...
                break
        # Calculation for Vector Dot Product
        if(geometry_selection == 1 and calc_selection_3 == 5):
            while True:
                try:
                ...
                while True:
                    ...
                    break
                break
        # Calculation for Radians to Degrees
        if(geometry_selection == 1 and calc_selection_3 == 6):
            while True:
                try: 
                ...
                break
        # Calculation for Degrees to Radians
        if(geometry_selection == 1 and calc_selection_3 == 7):
            while True:
                try: 
