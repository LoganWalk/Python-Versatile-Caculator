def main():
    ...
    i = 0
    # Multiply the rest of the coeffs by the answer coeff value
    for i in range(len(coeff_list_2)):
        coeff_list_2[i] *= answer_coeff
    # Mulitply the rest of the exponents values by the answer exp value
    for i in range(len(exp_list_2)):
        exp_list_2[i] *= answer_exp
